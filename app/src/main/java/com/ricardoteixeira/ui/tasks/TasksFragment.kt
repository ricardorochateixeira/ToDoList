...
import com.ricardoteixeira.todolist.R
import com.ricardoteixeira.todolist.databinding.FragmentTasksBinding
import com.ricardoteixeira.util.exhaustive
import com.ricardoteixeira.util.onQueryTextChanged
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.flow.collect
import kotlinx.coroutines.flow.first
import kotlinx.coroutines.launch

//Fragments and Activities cannot eb constructed injected
@AndroidEntryPoint
class TasksFragment(): Fragment(R.layout.fragment_tasks), TasksAdapter.OnItemClickListener {

    private val viewModel: TasksViewModel by viewModels() //injected by dagger
